module.exports = {
  ...
  device: {
    ...
    online: 'Online',
    offline: 'Offline',
    activeReqSuccess: 'Request activation successful',
    activeSuccess: 'Activation completed',
    activeErr: 'Activation failed',
    activing: 'Activating',
    active: 'Not Active',
    cancelAlarm: 'Cancel Alarm',
    cancelActive: 'Cancel Activation',
    activeBtn: 'Activation',
    alarm: 'Alarm',
    alarmCanceling: 'Cancel Alarm',
    CancelActiving: 'Cancel Activation',
    activeStatus: 'Status'
  },
  addDevice: {
